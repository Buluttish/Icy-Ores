...
public class FrozenFenceBlock extends IceOresModElements.ModElement {
	@ObjectHolder("ice_ores:frozen_fence")
	public static final Block block = null;
	public FrozenFenceBlock(IceOresModElements instance) {
		super(instance, 27);
	}
