...
public class FrozenStairsBlock extends IceOresModElements.ModElement {
	@ObjectHolder("ice_ores:frozen_stairs")
	public static final Block block = null;
	public FrozenStairsBlock(IceOresModElements instance) {
		super(instance, 25);
	}
